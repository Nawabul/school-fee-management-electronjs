  ...
  return (
    <div className={`bg-slate-800 p-6 rounded-xl shadow-lg ${className}`}>
      <div className="flex items-start justify-between mb-4">
        <div>
          <h3 className="text-lg font-semibold text-white">Payment Collection Overview</h3>
          <p className="text-sm text-slate-400">
            Total Revenue This Session:{' '}
      ...
      <div className="h-80 w-full">
        {chartData.length == 0 && (
          <div className="text-center text-lg text-white">No Data Available</div>
        )}
